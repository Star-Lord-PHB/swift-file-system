...
enum InternalFS {
    ...
    static func ustat(_ path: FilePath) throws(SystemError) -> CInterop.Stat {
    ...
    static func chown(forItemAt path: FilePath, owner: PlatformIdentity?, group: PlatformIdentity?) throws(SystemError) {
